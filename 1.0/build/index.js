...
gallery/ringNavi/1.0/index

*/
/**
 * @fileoverview 移动设备上常见的环状导航组件
 * @author Letao<mailzwj@126.com>
 * @module ringNavi
 **/
KISSY.add('gallery/ringNavi/1.0/index',function (S, Node,Base) {
    var EMPTY = '';
    var $ = Node.all;
	var PI = Math.PI;
	var ONE = PI / 180;
